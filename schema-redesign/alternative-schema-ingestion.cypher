// EXERCICI 3: NOU ESQUEMA DE GRAF

// 0. Constraints i indexos del nou esquema
...
// 2. Carrega de municipis, padrons i habitatges
...
// 3. Carrega dels carrers i relacio habitatge-carrer
LOAD CSV WITH HEADERS FROM 'file:///HABITATGES.csv' AS row
WITH row
WHERE row.Municipi IS NOT NULL
  AND trim(toString(row.Municipi)) <> ''
...
// 4. Carrega de la relacio VIU_A i APAREIX_EN
...
// 5. Carrega de la relacio FAMILIA_AMB
...
// 6. Carrega de la relacio SAME_AS_V2
